...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: "sidebars", label: "Sidebars & Widgets", icon: PanelRight, href: "/admin/cms/sidebars" },
  {
    ...
    children: [
      { id: "generator-landing", label: "Landing Pages", href: "/admin/cms/generator/landing" },
      { id: "generator-campaigns", label: "Campaign Packs", href: "/admin/cms/generator/campaigns" },
    ],
  },
  { id: "themes", label: "Themes", icon: Palette, href: "/admin/cms/themes" },
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col" data-testid="cms-layout">
      ...
      <div className="flex flex-1">
        ...
        <div className={cn("flex-1 flex flex-col transition-all duration-200", collapsed ? "ml-16" : "ml-56")}>
          <header className="sticky top-[73px] z-20 bg-background/90 backdrop-blur-sm border-b border-border h-12 flex items-center gap-4 px-6" data-testid="cms-topbar">
            {breadcrumbs && breadcrumbs.length > 0 && (
              <nav className="flex items-center gap-1 text-sm" data-testid="cms-breadcrumbs">
                <Link href="/admin/cms">
          ...
          <main className="flex-1 p-6" data-testid="cms-main">
            {children}
          </main>
        </div>
      </div>
