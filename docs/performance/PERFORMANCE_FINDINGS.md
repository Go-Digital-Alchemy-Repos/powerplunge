...
|-------|-------|---------|-------|
| `idx_cms_v2_posts_status_published` | `cms_v2_posts` | `status, published_at DESC` | Historical Stack B index; table verified empty and removed |
| `idx_cms_v2_posts_category` | `cms_v2_posts` | `category` | Historical Stack B index; table verified empty and removed |
