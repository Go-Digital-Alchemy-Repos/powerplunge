...
The CMS page builder supports a `blogPostFeed` block that enables admins to create custom blog index pages using the visual page builder.
...
1. Create a CMS page (e.g., slug: `blog`).
...
The block is registered in the CMS block registry and available in the Puck page builder sidebar.
