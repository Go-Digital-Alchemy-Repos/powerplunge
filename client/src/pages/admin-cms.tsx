...
import { FileText, Layers, BookTemplate, Palette, Search, Globe, Plus, ArrowRight, Clock, Settings, Wand2, Package, PanelRight } from "lucide-react";
...
const dashboardCards = [
  ...
  },
  {
    ...
    testId: "card-cms-generator-landing",
  },
  {
    title: "Site Presets",
    description: "Pre-configured site personalities",
    icon: Package,
    href: "/admin/cms/presets",
    action: "Manage Presets",
    testId: "card-cms-presets",
  },
  {
    title: "Sidebars & Widgets",
    description: "Manage sidebar areas and reusable widgets",
    icon: PanelRight,
    href: "/admin/cms/sidebars",
    action: "Manage Sidebars",
    testId: "card-cms-sidebars",
  },
  {
    title: "SEO Toolkit",
...
export default function AdminCms() {
  ...
  return (
    <CmsLayout activeNav="dashboard" data-testid="admin-cms-page">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8" data-testid="cms-stats">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-10" data-testid="cms-dashboard-cards">
        ...
        {recentItems.length > 0 && (
          <div>
            ...
            <div className="space-y-1" data-testid="cms-recent-items">
              {recentItems.map((item) => (
                <Link
                  key={`${item.type}-${item.id}`}
                  href={item.type === "page" ? `/admin/cms/pages/${item.id}/builder` : "/admin/cms/sections"}
                >
