...
The CMS v2 menus system allows admins to manage site navigation through a visual drag-and-drop interface.
...
interface MenuItem {
  ...
  pageId?: string;      // FK to CMS v2 page
...
|------|-------------|-----------------|
| `page` | Links to a CMS v2 page | `/page/:pageSlug` |
...
All admin endpoints require authentication and `CMS_V2_ENABLED = true`.

### CRUD Endpoints

| Method | Path | Description |
|--------|------|-------------|
| `GET` | `/api/admin/cms-v2/menus` | List all menus |
| `POST` | `/api/admin/cms-v2/menus` | Create a new menu |
| `GET` | `/api/admin/cms-v2/menus/:id` | Get menu by ID |
| `PUT` | `/api/admin/cms-v2/menus/:id` | Update menu by ID |
| `DELETE` | `/api/admin/cms-v2/menus/:id` | Delete menu by ID |

### By-Location Endpoints

| Method | Path | Description |
|--------|------|-------------|
| `GET` | `/api/admin/cms-v2/menus/by-location/:location` | Get menu for a specific location |
| `PUT` | `/api/admin/cms-v2/menus/by-location/:location` | Upsert menu for a location |
...
**When CMS v2 disabled:** Returns `null`.

---

## Admin UI

The menus manager is at `/admin/cms-v2/menus`.
...
| File | Purpose |
|------|---------|
| `shared/schema.ts` | `cmsV2Menus` table, `menuItemSchema` Zod schema |
| `server/src/routes/admin/cms-v2-menus.routes.ts` | Admin API routes |
| `server/src/services/cms-v2-menus.service.ts` | Service layer |
| `server/src/repositories/cms-v2-menus.repository.ts` | Database queries |
| `server/src/routes/public/blog.routes.ts` | Public menu endpoint (`publicMenuRoutes`) |
| `client/src/pages/admin-cms-v2-menus.tsx` | Admin UI |
