import { postsRepository, type PostListFilters } from "../repositories/cmsV2.posts.repo";
import type { PostStatus } from "../schemas/cmsV2.posts.schema";
...
class PostsService {
  ...
  private async createRevisionSnapshot(postId: string, post: any, userId?: string) {
    try {
      ...
      console.error("[CMS-V2-POSTS] Failed to create revision:", err);
    }
  }
}
